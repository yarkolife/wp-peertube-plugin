...
class PT_Channel_Videos {
	...
	public static function render( $atts ) {
		...
		if ( empty( $channel ) ) {
			return '<p class="pt-no-videos">' . esc_html__( 'Bitte geben Sie einen Kanal mit dem channel-Attribut an.', 'peertube-video-manager' ) . '</p>';
		}
		...
		if ( empty( $result['data'] ) ) {
			return '<p class="pt-no-videos">' . sprintf(
				...
				esc_html__( 'Keine Videos im Kanal "%s" gefunden.', 'peertube-video-manager' ),
				esc_html( $channel )
			) . '</p>';
		}
